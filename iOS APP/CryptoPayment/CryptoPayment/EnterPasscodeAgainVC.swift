...
class EnterPasscodeAgainVC: UIViewController {
    ...
    func forwardMove()  {
        if tfWorking == tfCode1{
            ...
            if((tfCode1.text! == frstTfVal)&&(tfCode2.text! == SecTfVal)&&(tfCode3.text! == thrdTfVal)&&(tfCode4.text! == fourthTFVal)){
                ...
                let SetPassCodeVC = MainStry.instantiateViewController(withIdentifier: Constant.ViewControllerID.kPasscodeFrst) as! SetPasscodeFirst
                SetPassCodeVC.path_value = "Setting"
