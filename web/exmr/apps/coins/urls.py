...
urlpatterns = [
    ...
    path('<str:currency>/address/<int:pk>/update/', coin_views.CoinAddrUpdate.as_view(), name='label'),
    path('hidden_addr/<str:currency>/', coin_views.HiddenAddress.as_view(), name='hidden_addr'),
    path('newaddr/<str:currency>/hide/<int:pk>/', coin_views.CoinHide.as_view(), name='hide'),
